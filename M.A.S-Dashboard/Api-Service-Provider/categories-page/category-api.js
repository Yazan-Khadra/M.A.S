...
const confirm_delete_category_btn = document.getElementById('delete-btn');
...
function create_delete_update_button(obj) {
    ...
    // let category_id = document.createAttribute('category_id');

    // add Event listner
    delete_button.addEventListener('click',function() {
             delete_overlay.style.opacity = "1";
            delete_overlay.style.pointerEvents = "auto";
            confirm_delete_category_btn.setAttribute("category_id",obj.id);
...
function delete_category(category_id) {
 ...
 const data = {
    ...
    fetch(`http://127.0.0.1:8000/api/categories/delete`,{
        method : "DELETE",
        headers : {
...
function confirm_delete_category() {
    confirm_delete_category_btn.onclick = function() {
        delete_category(confirm_delete_category_btn.getAttribute("category_id"));
    }
}
...
// categories_filter();
    ...
    // const confirm_delete_category = document.getElementById('delete-btn');
    // delete_buttons.forEach((button) => {
    //     button.addEventListener('click',function(e) {
    //        category_id = e.currentTarget.getAttribute("category_id");
      
    //     });
    // });
    //         confirm_delete_category.addEventListener('click',function() {
    //             console.log("hay");
